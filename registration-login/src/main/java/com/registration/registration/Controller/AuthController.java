...
public class AuthController {
	  ...
	  private com.registration.registration.Service.userService userService;

	    public AuthController(com.registration.registration.Service.userService userService) {
